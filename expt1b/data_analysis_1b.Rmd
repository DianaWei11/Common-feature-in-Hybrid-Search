...
# Aggregate RT by subID and cond_level
wide_data <- search %>%
  filter(tasks == "search", correct == 1, trial_struc != "target repeat", cond_color != "neutral") %>%
  group_by(subID, cond_target, cond_color) %>%
  summarise(mean_rt = mean(RT), .groups = "drop") %>%
...
# Calculate differences and Cohen's d
wide_data <- wide_data %>%
  mutate(difference = Target1_color1 - Target3_color1)
# Target1_color1 - Target3_color1 = 0.45
# Target1 color1 - Target3 color1     34.724  9.18 68   3.781  0.0119
# Target1_color2 - Target2_color2 = 0.28
#                                     estimate    SE      df    t.ratio     p.value
# Target1 color2 - Target2 color2     -28.924     12.30   68    -2.344       0.7916
# Target2_color1 - Target3_color2 = 0.37
#Target2 color1 - Target3 color2     40.760 13.20 68   3.082  0.1069
